...
@Autonomous(name = "Autonomous2021", group = "Linear OpMode")
//@Disabled
    ...
    public void runOpMode() {
        ...
        */
        ...
        if (objectsFound.equals("None")) {
            ...
            // go to white line
            goBackwardEncoder((BZoneDistance-8)*goForBakDistanceCorrection, motorPower);
            ...
            strafeLeftEncoder(moreGoalRoom*goStrafeDistanceCorrection, motorPower);
            // go to white line
            goBackwardEncoder((CZoneDistance-8)*goForBakDistanceCorrection, motorPower);
        }
